...
<figure style="text-align: center;">
  <img src="shakl-7.png" alt="مشاهده بخشی از فیلدهای دستورکارهای ارجاع شده به گروه که از طریق CMMS دریافت میشود. (این شکل ادامه دارد...)" style="width: 90%;">
  <figcaption>مشاهده بخشی از فیلدهای دستورکارهای ارجاع شده به گروه که از طریق CMMS دریافت میشود. (این شکل ادامه دارد...)</figcaption>
</figure>
...
<figure style="text-align: center;">
  ...
  <figcaption>پنجره مشاهده اطلاعات کامل دستور کارها و ثبت نظر سرپرست گروه در مورد نیازمندیها و بازه زمانی انجام دستورکار.</figcaption>
</figure>
...
<figure style="text-align: center;">
  ...
  <figcaption>بخش گروههای همکار در پنجره مشاهده اطلاعات کامل دستور کارها و ثبت نظر سرپرست گروه در مورد نیازمندیها و بازه زمانی انجام دستورکار.</figcaption>
</figure>
...
<figure style="text-align: center;">
  ...
  <figcaption>گزارش تصویری از تخصیص و برنامه ریزی کارها توسط سامانه.</figcaption>
</figure>

<figure style="text-align: center;">
  <img src="shakl-11.png" alt="فیلتر کردن و نمایش برنامه فقط یک تیم از گروه در گزارش تصویری." style="width: 70%;">
  <figcaption>فیلتر کردن و نمایش برنامه فقط یک تیم از گروه در گزارش تصویری.</figcaption>
</figure>
...
<figure style="text-align: center;">
  ...
  <figcaption>نمایش کارهای کارهای چند تیمی با دایره زرد و نمایش کارهایی که با تاخیر برنامه ریزی شده اند با دایره سبز.</figcaption>
</figure>
...
<figure style="text-align: center;">
  ...
  <figcaption>دیدن جزئیات بیشتر در مورد یک کار برنامه ریزی شده با کلیک روی آن کار مثل ساعت رسیدن تیم به محل کار و ساعت پایان کار توسط تیم و میزان تاخیر و تعجیل در برنامه ریزی.</figcaption>
</figure>
