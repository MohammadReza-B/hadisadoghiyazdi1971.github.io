...
در منطق خطر این رویداد معادل **از دست رفتن کنترل فرآیند (Loss of Process Control)** است؛ جایی که سیستم قادر به تمایز معتبر میان افراد تأثیرگذار و غیرتأثیرگذار نیست.
