...
$$(E(\hat{\mu}_j)) , (E(\hat{\mu}_j^2)) , (E(\hat{\mu}_j \hat{\mu}_{j'}))$$
...
$$E_{S_j, i}\{ E_{Z_1^n}[L^{(iv)}(\mu^{\star}, X_i)(\bar{X}_{S_j} - \mu)^4 | S_j, i] \}\\ = E[L^{(iv)}(\mu^{\star}, X_i)] E(\bar{X}_{S_j} - \mu)^4 \leq M \cdot E(\bar{X}_{S_j} - \mu)^4$$
...
$$Var[L(\bar{X}_{S_j}; X_i)] = Var[L(\mu, X_i)] + \frac{\sigma^2}{n_1} \{ E[(L'(\mu, X_i))^2] + Cov(L(\mu, X_i), L''(\mu, X_i)) \} + O\left(\frac{1}{n_1^2}\right)$$
...
$$Cov[L(\bar{X}_{S_j}, X_i), L(\bar{X}_{S_{j'}}, X_{i'})] = \frac{\sigma^2}{n_1^2} E(Y) (E[L'(\mu, X_i)])^2 - \frac{\sigma^4}{4n_1^2} (E[L''(\mu, X_i)])^2 + O\left(\frac{1}{n_1^2}\right)$$

اگر (i = i'):

$$Cov[L(\bar{X}_{S_j}, X_i), L(\bar{X}_{S_{j'}}, X_{i'})] = Var(L(\mu, X_i)) + \frac{\sigma^2}{n_1} \big[ E[L(\mu, X_i) L''(\mu, X_i)] - E[L(\mu, X_i)] E[L''(\mu, X_i)] \big] + \frac{\sigma^2}{n_1^2} E(Y) E[L'(\mu, X_i)]^2 - \frac{\sigma^4}{4n_1^2} [E(L''(\mu, X_i))]^2 + O\left(\frac{1}{n_1^2}\right)$$
...
$$Var(\hat{\mu}_j) = \frac{1}{n_2} \left[ Var[L(\mu, X_i)] + \frac{\sigma^2}{n_1} \left[ E[(L'(\mu, X_i))^2] + Cov(L(\mu, X_i), L''(\mu, X_i)) \right] \right] - \frac{n_2 - 1}{n_2} \frac{\sigma^2}{n_1} [E(L'(\mu, X_i))]^2 + O(1/n_1^2)$$

$$Cov(\hat{\mu}_j, \hat{\mu}_{j'}) = \left(1 - \frac{E(Y^{\ast})}{n_2^2}\right) \left[ \frac{\sigma^2}{n_1^2} E(Y) (E[L'(\mu, X_i)])^2 - \frac{\sigma^4}{4n_1^2} (E[L''(\mu, X_i)])^2 + O\left(\frac{1}{n_1^2}\right) \right] + \frac{E(Y^{\ast})}{n_2^2} \left[ Var(L(\mu, X_i)) + \frac{\sigma^2}{n_1} \{ E[L(\mu, X_i) L''(\mu, X_i)] - E[L(\mu, X_i)] E[L''(\mu, X_i)] \} + \frac{\sigma^2}{n_1^2} E(Y) E[L'(\mu, X_i)]^2 - \frac{\sigma^4}{4n_1^2} \{ E[L''(\mu, X_i)] \}^2 + O\left(\frac{1}{n_1^2}\right) \right]$$
...
$$(E(Y) = \frac{n_1^2}{n}) , (E(Y^*) = \frac{n_2^2}{n})$$

سپس:

$$Cov(\hat{\mu}_j, \hat{\mu}_{j'})\\ = (1 - \frac{1}{n}) \left[ \frac{\sigma^2}{n} (E[L'(\mu, X_i)])^2 - \frac{\sigma^4}{4n_1^2} (E[L''(\mu, X_i)])^2 + O(\frac{1}{n_1^2}) \right] \\ + \frac{1}{n} \left[ Var(L(\mu, X_i)) + \frac{\sigma^2}{n_1} \{ Cov(L(\mu, X_i), L''(\mu, X_i)) \} \right. \\
...
$$(\hat{\mu}_j) , (Cov(\hat{\mu}_j, \hat{\mu}_{j'}))$$
...
$$Var(\hat{\mu}_j)\\ = \frac{k}{n} \left[ Var(L(\mu, X_i)) + \frac{\sigma^2}{n} (\frac{k}{k - 1}) \{ E[(L'(\mu, X_i))^2] + Cov(L(\mu, X_i), L''(\mu, X_i)) \} \right] \\ + \frac{n - k}{n} \frac{\sigma^2}{n} \frac{k}{k - 1} \{ E[L'(\mu, X_i)] \}^2 + O(1/n_1^2)$$
...
$$Var(\hat{\mu}_j) = \frac{k}{n} \left[ Var[(X_i - \mu)^2] + \frac{4\sigma^4}{n} \left(\frac{k}{k - 1}\right) \right]$$
...
$$L(\hat{y}_{i, S_j}, y_i) = L(x_i^T \beta_0, y_i)\\ + L'(x_i^T \beta_0, y_i) x_i^T (\hat{\beta}_{S_j} - \beta_0) \\ + \frac{1}{2} L''(x_i^T \beta_0, y_i) (\hat{\beta}_{S_j} - \beta_0)^T x_i x_i^T (\hat{\beta}_{S_j} - \beta_0)\\ + R_n$$
...
$$E\{ L(\hat{y}_{i, S_j}, y_i) \} = E_{S_j, i}\{ E_{Z_1^n}[L(\hat{y}_{i, S_j}, y_i) | S_j, i] \} \\= E_{S_j, i}\{ E_{Z_1^n}[L(x_i^T \beta_0, y_i) | S_j, i] \}\\ + E_{S_j, i}\{ E_{Z_1^n}[L'(x_i^T \beta_0, y_i) x_i^T | S_j, i] E_{Z_1^n}[(\hat{\beta}_{S_j} - \beta_0) | S_j, i] \} \\ + \frac{1}{2} E_{S_j, i}\{ E_{Z_1^n}[L''(x_i^T \beta_0, y_i) | S_j, i] E_{Z_1^n}[(\hat{\beta}_{S_j} - \beta_0)^T x_i x_i^T (\hat{\beta}_{S_j} - \beta_0) | S_j, i] \}$$
...
$$Cov(L(\hat{y}_{i, S_j}, y_i), L(\hat{y}_{i', S_{j'}}, y_{i'}))\\ = \sigma^2 (E[L'(x_i^T \beta_0, y_i)])^2 x_i^T (\mathbf{X}_{S_j}^T \mathbf{X}_{S_{j'}})^{-1} (\mathbf{X}_1^T \mathbf{X}_1) (\mathbf{X}_{S_{j'}}^T \mathbf{X}_{S_{j'}})^{-1} x_{i'} \\ \quad + \frac{\sigma^4}{2} (E[L''(x_i^T \beta_0, y_i)])^2 \text{tr}((x_i x_i^T)(\mathbf{X}_{S_j}^T \mathbf{X}_{S_j})^{-1} (\mathbf{X}_1^T \mathbf{X}_1) (\mathbf{X}_{S_{j'}}^T \mathbf{X}_{S_{j'}})^{-1} (x_{i'} x_{i'}^T) \\ \quad (\mathbf{X}_{S_j}^T \mathbf{X}_{S_j})^{-1} (\mathbf{X}_1^T \mathbf{X}_1) (\mathbf{X}_{S_{j'}}^T \mathbf{X}_{S_{j'}})^{-1})$$
...
$$Cov(L(\hat{y}_{i, S_j}, y_i), L(\hat{y}_{i', S_{j'}}, y_{i'}))\\ = Var(L(x_i^T \beta_0, y_i)) + \frac{\sigma^2}{2} Cov(L(x_i^T \beta_0, y_i), L''(x_i^T \beta_0, y_i)) \\ \quad (x_i^T (\mathbf{X}_{S_{j'}}^T \mathbf{X}_{S_{j'}})^{-1} x_i + x_i^T (\mathbf{X}_{S_j}^T \mathbf{X}_{S_j})^{-1} x_i) \\
\quad + \sigma^2 (E[L'(x_i^T \beta_0, y_i)])^2 x_i^T (\mathbf{X}_{S_j}^T \mathbf{X}_{S_{j'}})^{-1} (\mathbf{X}_1^T \mathbf{X}_1) (\mathbf{X}_{S_{j'}}^T \mathbf{X}_{S_{j'}})^{-1} x_i \\ \quad + \frac{\sigma^4}{2} (E[L''(x_i^T \beta_0, y_i)])^2 \text{tr}((x_i x_i^T)(\mathbf{X}_{S_j}^T \mathbf{X}_{S_{j'}})^{-1} (\mathbf{X}_1^T \mathbf{X}_1) (\mathbf{X}_{S_{j'}}^T \mathbf{X}_{S_{j'}})^{-1} (x_i x_i^T) \\ \quad (\mathbf{X}_{S_j}^T \mathbf{X}_{S_j})^{-1} (\mathbf{X}_1^T \mathbf{X}_1) (\mathbf{X}_{S_{j'}}^T \mathbf{X}_{S_{j'}})^{-1}) \\ \quad + \frac{\sigma^4}{4} Var(L''(x_i^T \beta_0, y_i)) x_i^T (\mathbf{X}_{S_j}^T \mathbf{X}_{S_j})^{-1} x_i x_i^T (\mathbf{X}_{S_{j'}}^T \mathbf{X}_{S_{j'}})^{-1} x_i$$
...
$$Cov(L(\hat{y}_{i, S_j}, y_i), L(\hat{y}_{i', S_j}, y_{i'}))\\ = \sigma^2 (E[L'(x_i^T \beta_0, y_i)])^2 \text{tr}[(x_{i'} x_{i'}^T)(\mathbf{X}_{S_j}^T \mathbf{X}_{S_j})^{-1}] \\ \quad + \frac{\sigma^4}{2} (E[L''(x_i^T \beta_0, y_i)])^2 \text{tr}[(x_i x_i^T)(\mathbf{X}_{S_j}^T \mathbf{X}_{S_j})^{-1} (x_{i'} x_{i'}^T)(\mathbf{X}_{S_j}^T \mathbf{X}_{S_j})^{-1}]$$
...
$$Cov(\hat{\mu}_j, \hat{\mu}_{j'}) = \frac{1}{n_2^2} \sum_{i \in S_j^c} \sum_{i' \in S_{j'}^c, i \neq i'} \{ 2\sigma^4 \text{tr}\{ (x_i x_i^T)(\mathbf{X}_{S_j}^T \mathbf{X}_{S_j})^{-1} (\mathbf{X}_1^T \mathbf{X}_1) (\mathbf{X}_{S_{j'}}^T \mathbf{X}_{S_{j'}})^{-1} (x_{i'} x_{i'}^T) \\
 (\mathbf{X}_{S_{j'}}^T \mathbf{X}_{S_{j'}})^{-1} (\mathbf{X}_1^T \mathbf{X}_1) (\mathbf{X}_{S_j}^T \mathbf{X}_{S_j})^{-1} \} \} \\ + \frac{1}{n_2^2} \sum_{i \in S_j^c} \sum_{i' \in S_{j'}^c, i = i'} \{ 2\sigma^4 + 4\sigma^4 x_i^T (\mathbf{X}_{S_j}^T \mathbf{X}_{S_j})^{-1} (\mathbf{X}_1^T \mathbf{X}_1) (\mathbf{X}_{S_{j'}}^T \mathbf{X}_{S_{j'}})^{-1} x_i \\ + 2\sigma^4 \text{tr}\{ (x_i x_i^T)(\mathbf{X}_{S_j}^T \mathbf{X}_{S_j})^{-1} (\mathbf{X}_1^T \mathbf{X}_1) (\mathbf{X}_{S_{j'}}^T \mathbf{X}_{S_{j'}})^{-1} (x_i x_i^T) \\ (\mathbf{X}_{S_{j'}}^T \mathbf{X}_{S_{j'}})^{-1} (\mathbf{X}_1^T \mathbf{X}_1) (\mathbf{X}_{S_j}^T \mathbf{X}_{S_j})^{-1} \} \}$$
...
تعدیلات دیگری که توزیع $\(X\)$ را در نظر می‌گیرند مورد نیاز هستند. اینها عمدتاً بر گرفتن امیدهای ریاضی، روی $\(X\)$، از جمله‌هایی که توابعی از $\(X\)$ها هستند، متمرکز می‌شوند و می‌توانند به راحتی از داده‌ها با استفاده از بوت‌استرپ محاسبه شوند. به عنوان نشانه، تحت زیان مربعات خطا، فرمول در 
گزاره ۳.۴ می‌شود 
