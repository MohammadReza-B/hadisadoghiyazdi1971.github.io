...
<nav class="toc" dir="rtl" aria-label="فهرست مطالب" style="text-align:right;">
...
<ol style="margin:0; padding-right:1.25rem; line-height:1.9;">
    <li>
      <a href="#طبقه-بندی-تطبیقی-متن">طبقه‌بندی تطبیقی متن</a>
    </li>
    <li>
      <a href="#مقدمه-و-پیش-نیاز-ها">مقدمه و پیش نیاز ها</a>
    </li>
    <li>
      <a href="#بردار-های-معنایی-در-langchain-و-ذخیره-سازی-آن-ها">بردار های معنایی در langchain و ذخیره سازی آن ها</a>
    </li>
    <li>
      <a href="#ذخیره-سازی-بردار-های-معنایی-در-langchain">ذخیره سازی بردار های معنایی در langchain</a>
    </li>
    <li>
      <a href="#مثال-1-خوشه-بندی-متن-و-انتخاب-موضوع">مثال : خوشه بندی متن و انتخاب موضوع</a>
    </li>
    <li>
...
<div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
    <img src="/assets/patterneffort/unsupervised_text_classification/Diagram.svg" alt="STFT-overview" style="width: 70%; height: 70%; object-fit: contain;">
</div>
